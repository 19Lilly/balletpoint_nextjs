...
const DesktopTimeTable = ({ className }) => {
  return (
    <div
      className={`${className} md:grid-cols-[auto_1fr_1fr_1fr_1fr] divide-y divide-x border-b border-r text-center`}
    >
      ...
      <div className='p-2 bg-purple-600 text-white  flex flex-col items-center'>
        <p>Classic 2</p>
        <p>Klasický tanec</p>
      </div>
