...
const platby = [
  {
    id: uuid(),
    name: '1.platba',
    months: ['Lamač: September + Október', 'Podunajské Biskupice: Október'],
    dueDate: ['Lamač: 1.9.2026', 'Podunajské Biskupice: 1.10.2026'],
  },
  {
    id: uuid(),
    name: '2.platba',
...
const eventsData = [
  {
    ...
    url: 'https://kultura.karlovaves.sk/events/222/karloveske-hody-2026-09-25-lERp8',
